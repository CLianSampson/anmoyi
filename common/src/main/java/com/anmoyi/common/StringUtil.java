...
public class StringUtil {
	...
	public static String encodeBase64(String value) {
		return Const.BASE64_RANDOM_COMPANYID + Base64.encode(value);
	...
	public static String decodeBase64(String value) {
		if (value == null || value.length() <= Const.BASE64_RANDOM_COMPANYID.length()) {
			return "";

		} else {
			int count = value.length();
			int last = Const.BASE64_RANDOM_COMPANYID.length();
	...
	public static void main(String[] args) {
		Boolean flag =  StringUtil.isEmail("1888@163.com");
